...
readonly UI_CN_VERSION="v1.1.0-CN-20240510183612"
readonly UI_EN_VERSION="v1.1.0-EN-20240510183642"
readonly API_VERSION="v1.1.0-20240510183110"
readonly HELIX_VERSION="v1.0.1-20240329104039"
...
online_install_upm_platform() {
  ...
  helm install ${RELEASE} ${CHART} \
    ...
    --set-string service-redis-cluster.nodeAffinityPreset.type="hard" \
    --set-string service-redis-cluster.nodeAffinityPreset.key="upm\.platform\.node" \
    --set-string service-redis-cluster.nodeAffinityPreset.values='{enable}' \
    --set-string service-redis-cluster.resources.limits.cpu="${PLATFORM_RESOURCE_LIMITS_CPU}" \
