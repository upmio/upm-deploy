...
readonly TESSERACT_VERSION=""
readonly SCEPTER_VERSION=""
readonly GAUNTLET_VERSION=""
readonly TEMPLATE_VERSION=""

ENGINE_KUBE_NAMESPACE="${ENGINE_KUBE_NAMESPACE:-upm-system}"
ENGINE_RESOURCE_LIMITS_CPU="${REDIS_RESOURCE_LIMITS_CPU:-1000m}"
ENGINE_RESOURCE_LIMITS_MEMORY="${REDIS_RESOURCE_LIMITS_MEMORY:-2Gi}"
ENGINE_RESOURCE_REQUESTS_CPU="${REDIS_RESOURCE_REQUESTS_CPU:-1000m}"
